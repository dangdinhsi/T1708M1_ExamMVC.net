...
namespace MVCdotNetCoreT1708M1.Controllers
{
    public class CategoriesController : Controller
    {
        private readonly MVCdotNetCoreT1708M1Context _context;

        public CategoriesController(MVCdotNetCoreT1708M1Context context)
        {
            _context = context;
        }
